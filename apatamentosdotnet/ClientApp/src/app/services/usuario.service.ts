...
export class UsuarioService {
  ...
  post(usuario: Usuario): Observable<Usuario> {
    ...
    buscar(id:string):Observable<Usuario> {
      return this.http.post<Usuario>(this.baseUrl + 'api/Usuario/5', id)
      .pipe(
      tap(_ => this.handleErrorService.log('datos enviados')),
    ...
    /*  Cambiar(): Observable<Usuario[]>{return this.http.put<Usuario[]>(this.baseUrl + 'api/Usuario/')
      .pipe(
      tap(_ => this.handleErrorService.log('datos enviados')),
      catchError(this.handleErrorService.handleError<Usuario[]>('Consulta Usuario', null))
      );
      }*/
     Eliminar(): Observable<Usuario[]>{return this.http.delete<Usuario[]>(this.baseUrl + 'api/Usuario/5')
     .pipe(
     tap(_ => this.handleErrorService.log('datos enviados')),
     catchError(this.handleErrorService.handleError<Usuario[]>('Consulta Usuario', null))
     );
